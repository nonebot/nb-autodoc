...
class TestModuleManager:
    def test_refine_autodoc(self, simple_manager: ModuleManager):
        ...
        assert simple_manager.modules["simple_pkg.reexport"].exist_reference == {
            "fa": Reference(simple_manager, "simple_pkg.reexport._sample", "fa"),
            "_fc": Reference(simple_manager, "simple_pkg.reexport._sample", "_fc"),
            "A": Reference(simple_manager, "simple_pkg.reexport._sample", "A"),
            "inter_A": Reference(simple_manager, "simple_pkg.reexport._sample", "A"),
            "reexport_inter_A": Reference(
                simple_manager, "simple_pkg.reexport._sample", "A"
            ),
        }
        assert simple_manager.modules["simple_pkg.reexport"].exist_libraryattr == {
            "Path": LibraryAttr("Path", "stdlib pathlib.Path docstring..."),
        }
        ...
        for name in filter(
            ...
            assert module.exist_reference == {}
            assert module.exist_libraryattr == {}
